      ...
      <div className="container mx-auto grid  grid-cols-1 lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 gap-10">
        ...
        <div>
          <p className="leading-loose mb-5 text-justify">
            ...
            for every moment - on your phone, computer, tablet, and more. You
          ...
          <p className="leading-loose text-justify">
            ...
            services online. Outsource your music streaming project and get it
            quickly done and delivered remotely online. High-quality audio with
            a wide range of content. Students will be effective performers.
            Music is available at any time and any place. hi-def video quality,
            along with expertly curated playlists and original content. Offers a
            Solution to Music Piracy. It is a Great Source of Exposure,
            Especially for New Artists. It Has Encouraged People to Pay for
            Music.
          </p>
        </div>
      </div>
