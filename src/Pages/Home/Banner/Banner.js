    ...
    <section className='px-5 py-12'>
      <div className="container mx-auto grid items-center grid-cols-1 lg:grid-cols-2 gap-10">
        <div>
          ...
          <button onClick={()=>navigate('/dashboard')} className='px-4 py-2 font-semibold text-sm border border-sky-500 text-white rounded-md shadow-sm opacity-100 mr-10'>Explore</button>
          <button onClick={()=>navigate('/pricing')} className='px-4 py-2 font-semibold text-sm bg-sky-500 text-white rounded-md shadow-sm opacity-100'>Subscribe</button>
        </div>
        <div>
