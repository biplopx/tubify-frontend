...
const Explore = () => {
  ...
  const menuItems = <>
    <li className='flex items-center py-3'><i className="ri-home-line text-xl mr-3"></i> <Link to="/explore">Explore</Link></li>
    <li className='flex items-center py-3'><i className="ri-folder-music-line text-xl mr-3"></i> <Link to="/explore/your-libary">Your Libary</Link></li>
  </>
          ...
          <div className="relative inline-block text-left">
            ...
            <div className={`origin-top-right absolute right-0 mt-5 w-56 rounded-md shadow-lg secondary-bg ring-1 ring-black ring-opacity-5 divide-y divide-gray-100 focus:outline-none ${isMyAccountMenuOpen ? "block" : "hidden"}`} role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabIndex="-1">
              <div className="py-1" role="none">
                <Link to="/" className="text--white block px-4 py-2 text-sm" role="menuitem" tabindex="-1" id="menu-item-0">Profile</Link>
